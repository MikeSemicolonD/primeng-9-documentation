...
let Listbox = class Listbox {
    ...
    removeOption(option) {
        this.value = this.value.filter(val => !primeng_utils__WEBPACK_IMPORTED_MODULE_5__["ObjectUtils"].equals(val, option.value, this.dataKey));
    }
    isSelected(option) {
        let selected = false;
        if (this.multiple) {
    ...
    findNextItem(item) {
        ...
        if (nextItem)
            return primeng_dom__WEBPACK_IMPORTED_MODULE_4__["DomHandler"].hasClass(nextItem, 'ui-state-disabled') || primeng_dom__WEBPACK_IMPORTED_MODULE_4__["DomHandler"].isHidden(nextItem) ? this.findNextItem(nextItem) : nextItem;
        else
            return null;
    }
    findPrevItem(item) {
        ...
        if (prevItem)
            return primeng_dom__WEBPACK_IMPORTED_MODULE_4__["DomHandler"].hasClass(prevItem, 'ui-state-disabled') || primeng_dom__WEBPACK_IMPORTED_MODULE_4__["DomHandler"].isHidden(prevItem) ? this.findPrevItem(prevItem) : prevItem;
        else
            return null;
    }
    getFilteredOptions() {
...
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('headerchkbox'),
...
Listbox = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
  ...
  `,
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["ChangeDetectorRef"]])
], Listbox);

let ListboxModule = class ListboxModule {
};
ListboxModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _listbox__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./listbox */ "./src/app/components/listbox/listbox.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "LISTBOX_VALUE_ACCESSOR", function() { return _listbox__WEBPACK_IMPORTED_MODULE_0__["LISTBOX_VALUE_ACCESSOR"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Listbox", function() { return _listbox__WEBPACK_IMPORTED_MODULE_0__["Listbox"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "ListboxModule", function() { return _listbox__WEBPACK_IMPORTED_MODULE_0__["ListboxModule"]; });
